...
- (red link) [[Softmax]] — multi-class generalization, with the coupled-probabilities trade-off.
- (red link) [[Cross-Entropy Loss]] — pairs with sigmoid in the numerically-stable `BCEWithLogits` formulation.
