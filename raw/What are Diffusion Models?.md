...
$$
q \left(\right. \mathbf{x}_{t} \left|\right. \mathbf{x}_{t - 1} \left.\right) = \mathcal{N} \left(\right. \mathbf{x}_{t} ; \sqrt{1 - \beta_{t}} \mathbf{x}_{t - 1} , \beta_{t} \mathbf{I} \left.\right) q \left(\right. \mathbf{x}_{1 : T} \left|\right. \mathbf{x}_{0} \left.\right) = \prod_{t = 1}^{T} q \left(\right. \mathbf{x}_{t} \left|\right. \mathbf{x}_{t - 1} \left.\right)
$$
...
$$
\mathbf{x}_{t} & = \sqrt{\alpha_{t}} \mathbf{x}_{t - 1} + \sqrt{1 - \alpha_{t}} \mathbf{\mathit{\epsilon}}_{t - 1} & ;\text{where } \mathbf{\mathit{\epsilon}}_{t - 1} , \mathbf{\mathit{\epsilon}}_{t - 2} , \hdots sim \mathcal{N} \left(\right. 0 , \mathbf{I} \left.\right) \\ = \sqrt{\alpha_{t} \alpha_{t - 1}} \mathbf{x}_{t - 2} + \sqrt{1 - \alpha_{t} \alpha_{t - 1}} \bar{\mathbf{\mathit{\epsilon}}}_{t - 2} & ;\text{where } \bar{\mathbf{\mathit{\epsilon}}}_{t - 2} \text{merges two Gaussians }(*). \\ = \ldots \\ = \sqrt{\bar{\alpha}_{t}} \mathbf{x}_{0} + \sqrt{1 - \bar{\alpha}_{t}} \mathbf{\mathit{\epsilon}} \\ q \left(\right. \mathbf{x}_{t} \left|\right. \mathbf{x}_{0} \left.\right) & = \mathcal{N} \left(\right. \mathbf{x}_{t} ; \sqrt{\bar{\alpha}_{t}} \mathbf{x}_{0} , \left(\right. 1 - \bar{\alpha}_{t} \left.\right) \mathbf{I} \left.\right)
$$
...
$$
\mathbf{x}_{t} = \mathbf{x}_{t - 1} + \frac{\delta}{2} \nabla_{\mathbf{x}} log ⁡ p \left(\right. \mathbf{x}_{t - 1} \left.\right) + \sqrt{\delta} \mathbf{\mathit{\epsilon}}_{t} , \text{where } \mathbf{\mathit{\epsilon}}_{t} sim \mathcal{N} \left(\right. 0 , \mathbf{I} \left.\right)
$$
...
$$
p_{\theta} \left(\right. \mathbf{x}_{0 : T} \left.\right) = p \left(\right. \mathbf{x}_{T} \left.\right) \prod_{t = 1}^{T} p_{\theta} \left(\right. \mathbf{x}_{t - 1} \left|\right. \mathbf{x}_{t} \left.\right) p_{\theta} \left(\right. \mathbf{x}_{t - 1} \left|\right. \mathbf{x}_{t} \left.\right) = \mathcal{N} \left(\right. \mathbf{x}_{t - 1} ; \mathbf{\mathit{\mu}}_{\theta} \left(\right. \mathbf{x}_{t} , t \left.\right) , \mathbf{\Sigma}_{\theta} \left(\right. \mathbf{x}_{t} , t \left.\right) \left.\right)
$$
...
$$
q \left(\right. \mathbf{x}_{t - 1} \left|\right. \mathbf{x}_{t} , \mathbf{x}_{0} \left.\right) = \mathcal{N} \left(\right. \mathbf{x}_{t - 1} ; \overset{\sim}{\mathbf{\mathit{\mu}}} \left(\right. \mathbf{x}_{t} , \mathbf{x}_{0} \left.\right) , \overset{\sim}{\beta}_{t} \mathbf{I} \left.\right)
$$

Using Bayes’ rule, we have:

$$
q \left(\right. \mathbf{x}_{t - 1} \left|\right. \mathbf{x}_{t} , \mathbf{x}_{0} \left.\right) & = q \left(\right. \mathbf{x}_{t} \left|\right. \mathbf{x}_{t - 1} , \mathbf{x}_{0} \left.\right) \frac{q \left(\right. \mathbf{x}_{t - 1} \left|\right. \mathbf{x}_{0} \left.\right)}{q \left(\right. \mathbf{x}_{t} \left|\right. \mathbf{x}_{0} \left.\right)} \\ \propto exp ⁡ \left(\right. - \frac{1}{2} \left(\right. \frac{\left(\right. \mathbf{x}_{t} - \sqrt{\alpha_{t}} \mathbf{x}_{t - 1} \left.\right)^{2}}{\beta_{t}} + \frac{\left(\right. \mathbf{x}_{t - 1} - \sqrt{\bar{\alpha}_{t - 1}} \mathbf{x}_{0} \left.\right)^{2}}{1 - \bar{\alpha}_{t - 1}} - \frac{\left(\right. \mathbf{x}_{t} - \sqrt{\bar{\alpha}_{t}} \mathbf{x}_{0} \left.\right)^{2}}{1 - \bar{\alpha}_{t}} \left.\right) \left.\right) \\ = exp ⁡ \left(\right. - \frac{1}{2} \left(\right. \frac{\mathbf{x}_{t}^{2} - 2 \sqrt{\alpha_{t}} \mathbf{x}_{t} \mathbf{x}_{t - 1} + \alpha_{t} \mathbf{x}_{t - 1}^{2}}{\beta_{t}} + \frac{\mathbf{x}_{t - 1}^{2} - 2 \sqrt{\bar{\alpha}_{t - 1}} \mathbf{x}_{0} \mathbf{x}_{t - 1} + \bar{\alpha}_{t - 1} \mathbf{x}_{0}^{2}}{1 - \bar{\alpha}_{t - 1}} - \frac{\left(\right. \mathbf{x}_{t} - \sqrt{\bar{\alpha}_{t}} \mathbf{x}_{0} \left.\right)^{2}}{1 - \bar{\alpha}_{t}} \left.\right) \left.\right) \\ = exp ⁡ \left(\right. - \frac{1}{2} \left(\right. \left(\right. \frac{\alpha_{t}}{\beta_{t}} + \frac{1}{1 - \bar{\alpha}_{t - 1}} \left.\right) \mathbf{x}_{t - 1}^{2} - \left(\right. \frac{2 \sqrt{\alpha_{t}}}{\beta_{t}} \mathbf{x}_{t} + \frac{2 \sqrt{\bar{\alpha}_{t - 1}}}{1 - \bar{\alpha}_{t - 1}} \mathbf{x}_{0} \left.\right) \mathbf{x}_{t - 1} + C \left(\right. \mathbf{x}_{t} , \mathbf{x}_{0} \left.\right) \left.\right) \left.\right)
$$
...
$$
\overset{\sim}{\beta}_{t} & = 1 / \left(\right. \frac{\alpha_{t}}{\beta_{t}} + \frac{1}{1 - \bar{\alpha}_{t - 1}} \left.\right) = 1 / \left(\right. \frac{\alpha_{t} - \bar{\alpha}_{t} + \beta_{t}}{\beta_{t} \left(\right. 1 - \bar{\alpha}_{t - 1} \left.\right)} \left.\right) = \frac{1 - \bar{\alpha}_{t - 1}}{1 - \bar{\alpha}_{t}} \cdot \beta_{t} \\ \overset{\sim}{\mathbf{\mathit{\mu}}}_{t} \left(\right. \mathbf{x}_{t} , \mathbf{x}_{0} \left.\right) & = \left(\right. \frac{\sqrt{\alpha_{t}}}{\beta_{t}} \mathbf{x}_{t} + \frac{\sqrt{\bar{\alpha}_{t - 1}}}{1 - \bar{\alpha}_{t - 1}} \mathbf{x}_{0} \left.\right) / \left(\right. \frac{\alpha_{t}}{\beta_{t}} + \frac{1}{1 - \bar{\alpha}_{t - 1}} \left.\right) \\ = \left(\right. \frac{\sqrt{\alpha_{t}}}{\beta_{t}} \mathbf{x}_{t} + \frac{\sqrt{\bar{\alpha}_{t - 1}}}{1 - \bar{\alpha}_{t - 1}} \mathbf{x}_{0} \left.\right) \frac{1 - \bar{\alpha}_{t - 1}}{1 - \bar{\alpha}_{t}} \cdot \beta_{t} \\ = \frac{\sqrt{\alpha_{t}} \left(\right. 1 - \bar{\alpha}_{t - 1} \left.\right)}{1 - \bar{\alpha}_{t}} \mathbf{x}_{t} + \frac{\sqrt{\bar{\alpha}_{t - 1}} \beta_{t}}{1 - \bar{\alpha}_{t}} \mathbf{x}_{0}
$$
...
$$
\overset{\sim}{\mathbf{\mathit{\mu}}}_{t} & = \frac{\sqrt{\alpha_{t}} \left(\right. 1 - \bar{\alpha}_{t - 1} \left.\right)}{1 - \bar{\alpha}_{t}} \mathbf{x}_{t} + \frac{\sqrt{\bar{\alpha}_{t - 1}} \beta_{t}}{1 - \bar{\alpha}_{t}} \frac{1}{\sqrt{\bar{\alpha}_{t}}} \left(\right. \mathbf{x}_{t} - \sqrt{1 - \bar{\alpha}_{t}} \mathbf{\mathit{\epsilon}}_{t} \left.\right) \\ = \frac{1}{\sqrt{\alpha_{t}}} \left(\right. \mathbf{x}_{t} - \frac{1 - \alpha_{t}}{\sqrt{1 - \bar{\alpha}_{t}}} \mathbf{\mathit{\epsilon}}_{t} \left.\right)
$$
...
$$
- log ⁡ p_{\theta} \left(\right. \mathbf{x}_{0} \left.\right) & \leq - log ⁡ p_{\theta} \left(\right. \mathbf{x}_{0} \left.\right) + D_{\text{KL}} \left(\right. q \left(\right. \mathbf{x}_{1 : T} \left|\right. \mathbf{x}_{0} \left.\right) \parallel p_{\theta} \left(\right. \mathbf{x}_{1 : T} \left|\right. \mathbf{x}_{0} \left.\right) \left.\right) & ;\text{ KL is non}-\text{negative} \\ = - log ⁡ p_{\theta} \left(\right. \mathbf{x}_{0} \left.\right) + \mathbb{E}_{\mathbf{x}_{1 : T} sim q \left(\right. \mathbf{x}_{1 : T} \left|\right. \mathbf{x}_{0} \left.\right)} \left[\right. log ⁡ \frac{q \left(\right. \mathbf{x}_{1 : T} \left|\right. \mathbf{x}_{0} \left.\right)}{p_{\theta} \left(\right. \mathbf{x}_{0 : T} \left.\right) / p_{\theta} \left(\right. \mathbf{x}_{0} \left.\right)} \left]\right. \\ = - log ⁡ p_{\theta} \left(\right. \mathbf{x}_{0} \left.\right) + \mathbb{E}_{q} \left[\right. log ⁡ \frac{q \left(\right. \mathbf{x}_{1 : T} \left|\right. \mathbf{x}_{0} \left.\right)}{p_{\theta} \left(\right. \mathbf{x}_{0 : T} \left.\right)} + log ⁡ p_{\theta} \left(\right. \mathbf{x}_{0} \left.\right) \left]\right. \\ = \mathbb{E}_{q} \left[\right. log ⁡ \frac{q \left(\right. \mathbf{x}_{1 : T} \left|\right. \mathbf{x}_{0} \left.\right)}{p_{\theta} \left(\right. \mathbf{x}_{0 : T} \left.\right)} \left]\right. \\ \text{Let } L_{\text{VLB}} & = \mathbb{E}_{q \left(\right. \mathbf{x}_{0 : T} \left.\right)} \left[\right. log ⁡ \frac{q \left(\right. \mathbf{x}_{1 : T} \left|\right. \mathbf{x}_{0} \left.\right)}{p_{\theta} \left(\right. \mathbf{x}_{0 : T} \left.\right)} \left]\right. \geq - \mathbb{E}_{q \left(\right. \mathbf{x}_{0} \left.\right)} log ⁡ p_{\theta} \left(\right. \mathbf{x}_{0} \left.\right)
$$
...
$$
L_{\text{CE}} & = - \mathbb{E}_{q \left(\right. \mathbf{x}_{0} \left.\right)} log ⁡ p_{\theta} \left(\right. \mathbf{x}_{0} \left.\right) \\ = - \mathbb{E}_{q \left(\right. \mathbf{x}_{0} \left.\right)} log ⁡ \left(\right. \int p_{\theta} \left(\right. \mathbf{x}_{0 : T} \left.\right) d \mathbf{x}_{1 : T} \left.\right) \\ = - \mathbb{E}_{q \left(\right. \mathbf{x}_{0} \left.\right)} log ⁡ \left(\right. \int q \left(\right. \mathbf{x}_{1 : T} \left|\right. \mathbf{x}_{0} \left.\right) \frac{p_{\theta} \left(\right. \mathbf{x}_{0 : T} \left.\right)}{q \left(\right. \mathbf{x}_{1 : T} \left|\right. \mathbf{x}_{0} \left.\right)} d \mathbf{x}_{1 : T} \left.\right) \\ = - \mathbb{E}_{q \left(\right. \mathbf{x}_{0} \left.\right)} log ⁡ \left(\right. \mathbb{E}_{q \left(\right. \mathbf{x}_{1 : T} \left|\right. \mathbf{x}_{0} \left.\right)} \frac{p_{\theta} \left(\right. \mathbf{x}_{0 : T} \left.\right)}{q \left(\right. \mathbf{x}_{1 : T} \left|\right. \mathbf{x}_{0} \left.\right)} \left.\right) \\ \leq - \mathbb{E}_{q \left(\right. \mathbf{x}_{0 : T} \left.\right)} log ⁡ \frac{p_{\theta} \left(\right. \mathbf{x}_{0 : T} \left.\right)}{q \left(\right. \mathbf{x}_{1 : T} \left|\right. \mathbf{x}_{0} \left.\right)} \\ = \mathbb{E}_{q \left(\right. \mathbf{x}_{0 : T} \left.\right)} \left[\right. log ⁡ \frac{q \left(\right. \mathbf{x}_{1 : T} \left|\right. \mathbf{x}_{0} \left.\right)}{p_{\theta} \left(\right. \mathbf{x}_{0 : T} \left.\right)} \left]\right. = L_{\text{VLB}}
$$
...
$$
L_{\text{VLB}} & = \mathbb{E}_{q \left(\right. \mathbf{x}_{0 : T} \left.\right)} \left[\right. log ⁡ \frac{q \left(\right. \mathbf{x}_{1 : T} \left|\right. \mathbf{x}_{0} \left.\right)}{p_{\theta} \left(\right. \mathbf{x}_{0 : T} \left.\right)} \left]\right. \\ = \mathbb{E}_{q} \left[\right. log ⁡ \frac{\prod_{t = 1}^{T} q \left(\right. \mathbf{x}_{t} \left|\right. \mathbf{x}_{t - 1} \left.\right)}{p_{\theta} \left(\right. \mathbf{x}_{T} \left.\right) \prod_{t = 1}^{T} p_{\theta} \left(\right. \mathbf{x}_{t - 1} \left|\right. \mathbf{x}_{t} \left.\right)} \left]\right. \\ = \mathbb{E}_{q} \left[\right. - log ⁡ p_{\theta} \left(\right. \mathbf{x}_{T} \left.\right) + \sum_{t = 1}^{T} log ⁡ \frac{q \left(\right. \mathbf{x}_{t} \left|\right. \mathbf{x}_{t - 1} \left.\right)}{p_{\theta} \left(\right. \mathbf{x}_{t - 1} \left|\right. \mathbf{x}_{t} \left.\right)} \left]\right. \\ = \mathbb{E}_{q} \left[\right. - log ⁡ p_{\theta} \left(\right. \mathbf{x}_{T} \left.\right) + \sum_{t = 2}^{T} log ⁡ \frac{q \left(\right. \mathbf{x}_{t} \left|\right. \mathbf{x}_{t - 1} \left.\right)}{p_{\theta} \left(\right. \mathbf{x}_{t - 1} \left|\right. \mathbf{x}_{t} \left.\right)} + log ⁡ \frac{q \left(\right. \mathbf{x}_{1} \left|\right. \mathbf{x}_{0} \left.\right)}{p_{\theta} \left(\right. \mathbf{x}_{0} \left|\right. \mathbf{x}_{1} \left.\right)} \left]\right. \\ = \mathbb{E}_{q} \left[\right. - log ⁡ p_{\theta} \left(\right. \mathbf{x}_{T} \left.\right) + \sum_{t = 2}^{T} log ⁡ \left(\right. \frac{q \left(\right. \mathbf{x}_{t - 1} \left|\right. \mathbf{x}_{t} , \mathbf{x}_{0} \left.\right)}{p_{\theta} \left(\right. \mathbf{x}_{t - 1} \left|\right. \mathbf{x}_{t} \left.\right)} \cdot \frac{q \left(\right. \mathbf{x}_{t} \left|\right. \mathbf{x}_{0} \left.\right)}{q \left(\right. \mathbf{x}_{t - 1} \left|\right. \mathbf{x}_{0} \left.\right)} \left.\right) + log ⁡ \frac{q \left(\right. \mathbf{x}_{1} \left|\right. \mathbf{x}_{0} \left.\right)}{p_{\theta} \left(\right. \mathbf{x}_{0} \left|\right. \mathbf{x}_{1} \left.\right)} \left]\right. \\ = \mathbb{E}_{q} \left[\right. - log ⁡ p_{\theta} \left(\right. \mathbf{x}_{T} \left.\right) + \sum_{t = 2}^{T} log ⁡ \frac{q \left(\right. \mathbf{x}_{t - 1} \left|\right. \mathbf{x}_{t} , \mathbf{x}_{0} \left.\right)}{p_{\theta} \left(\right. \mathbf{x}_{t - 1} \left|\right. \mathbf{x}_{t} \left.\right)} + \sum_{t = 2}^{T} log ⁡ \frac{q \left(\right. \mathbf{x}_{t} \left|\right. \mathbf{x}_{0} \left.\right)}{q \left(\right. \mathbf{x}_{t - 1} \left|\right. \mathbf{x}_{0} \left.\right)} + log ⁡ \frac{q \left(\right. \mathbf{x}_{1} \left|\right. \mathbf{x}_{0} \left.\right)}{p_{\theta} \left(\right. \mathbf{x}_{0} \left|\right. \mathbf{x}_{1} \left.\right)} \left]\right. \\ = \mathbb{E}_{q} \left[\right. - log ⁡ p_{\theta} \left(\right. \mathbf{x}_{T} \left.\right) + \sum_{t = 2}^{T} log ⁡ \frac{q \left(\right. \mathbf{x}_{t - 1} \left|\right. \mathbf{x}_{t} , \mathbf{x}_{0} \left.\right)}{p_{\theta} \left(\right. \mathbf{x}_{t - 1} \left|\right. \mathbf{x}_{t} \left.\right)} + log ⁡ \frac{q \left(\right. \mathbf{x}_{T} \left|\right. \mathbf{x}_{0} \left.\right)}{q \left(\right. \mathbf{x}_{1} \left|\right. \mathbf{x}_{0} \left.\right)} + log ⁡ \frac{q \left(\right. \mathbf{x}_{1} \left|\right. \mathbf{x}_{0} \left.\right)}{p_{\theta} \left(\right. \mathbf{x}_{0} \left|\right. \mathbf{x}_{1} \left.\right)} \left]\right. \\ = \mathbb{E}_{q} \left[\right. log ⁡ \frac{q \left(\right. \mathbf{x}_{T} \left|\right. \mathbf{x}_{0} \left.\right)}{p_{\theta} \left(\right. \mathbf{x}_{T} \left.\right)} + \sum_{t = 2}^{T} log ⁡ \frac{q \left(\right. \mathbf{x}_{t - 1} \left|\right. \mathbf{x}_{t} , \mathbf{x}_{0} \left.\right)}{p_{\theta} \left(\right. \mathbf{x}_{t - 1} \left|\right. \mathbf{x}_{t} \left.\right)} - log ⁡ p_{\theta} \left(\right. \mathbf{x}_{0} \left|\right. \mathbf{x}_{1} \left.\right) \left]\right. \\ = \mathbb{E}_{q} \left[\right. \underset{L_{T}}{\underbrace{D_{\text{KL}} \left(\right. q \left(\right. \mathbf{x}_{T} \left|\right. \mathbf{x}_{0} \left.\right) \parallel p_{\theta} \left(\right. \mathbf{x}_{T} \left.\right) \left.\right)}} + \sum_{t = 2}^{T} \underset{L_{t - 1}}{\underbrace{D_{\text{KL}} \left(\right. q \left(\right. \mathbf{x}_{t - 1} \left|\right. \mathbf{x}_{t} , \mathbf{x}_{0} \left.\right) \parallel p_{\theta} \left(\right. \mathbf{x}_{t - 1} \left|\right. \mathbf{x}_{t} \left.\right) \left.\right)}} \underset{L_{0}}{\underbrace{- log ⁡ p_{\theta} \left(\right. \mathbf{x}_{0} \left|\right. \mathbf{x}_{1} \left.\right)}} \left]\right.
$$

Let’s label each component in the variational lower bound loss separately:

$$
L_{\text{VLB}} & = L_{T} + L_{T - 1} + \hdots + L_{0} \\ \text{where } L_{T} & = D_{\text{KL}} \left(\right. q \left(\right. \mathbf{x}_{T} \left|\right. \mathbf{x}_{0} \left.\right) \parallel p_{\theta} \left(\right. \mathbf{x}_{T} \left.\right) \left.\right) \\ L_{t} & = D_{\text{KL}} \left(\right. q \left(\right. \mathbf{x}_{t} \left|\right. \mathbf{x}_{t + 1} , \mathbf{x}_{0} \left.\right) \parallel p_{\theta} \left(\right. \mathbf{x}_{t} \left|\right. \mathbf{x}_{t + 1} \left.\right) \left.\right) \text{for } 1 \leq t \leq T - 1 \\ L_{0} & = - log ⁡ p_{\theta} \left(\right. \mathbf{x}_{0} \left|\right. \mathbf{x}_{1} \left.\right)
$$
...
$$
\mathbf{\mathit{\mu}}_{\theta} \left(\right. \mathbf{x}_{t} , t \left.\right) & = \frac{1}{\sqrt{\alpha_{t}}} \left(\right. \mathbf{x}_{t} - \frac{1 - \alpha_{t}}{\sqrt{1 - \bar{\alpha}_{t}}} \mathbf{\mathit{\epsilon}}_{\theta} \left(\right. \mathbf{x}_{t} , t \left.\right) \left.\right) \\ \text{Thus } \mathbf{x}_{t - 1} & = \mathcal{N} \left(\right. \mathbf{x}_{t - 1} ; \frac{1}{\sqrt{\alpha_{t}}} \left(\right. \mathbf{x}_{t} - \frac{1 - \alpha_{t}}{\sqrt{1 - \bar{\alpha}_{t}}} \mathbf{\mathit{\epsilon}}_{\theta} \left(\right. \mathbf{x}_{t} , t \left.\right) \left.\right) , \mathbf{\Sigma}_{\theta} \left(\right. \mathbf{x}_{t} , t \left.\right) \left.\right)
$$

The loss term $L_{t}$ is parameterized to minimize the difference from $\overset{\sim}{\mathbf{\mathit{\mu}}}$:

$$
L_{t} & = \mathbb{E}_{\mathbf{x}_{0} , \mathbf{\mathit{\epsilon}}} \left[\right. \frac{1}{2 \parallel \mathbf{\Sigma}_{\theta} \left(\right. \mathbf{x}_{t} , t \left.\right) \parallel_{2}^{2}} \parallel \overset{\sim}{\mathbf{\mathit{\mu}}}_{t} \left(\right. \mathbf{x}_{t} , \mathbf{x}_{0} \left.\right) - \mathbf{\mathit{\mu}}_{\theta} \left(\right. \mathbf{x}_{t} , t \left.\right) \parallel^{2} \left]\right. \\ = \mathbb{E}_{\mathbf{x}_{0} , \mathbf{\mathit{\epsilon}}} \left[\right. \frac{1}{2 \parallel \mathbf{\Sigma}_{\theta} \parallel_{2}^{2}} \parallel \frac{1}{\sqrt{\alpha_{t}}} \left(\right. \mathbf{x}_{t} - \frac{1 - \alpha_{t}}{\sqrt{1 - \bar{\alpha}_{t}}} \mathbf{\mathit{\epsilon}}_{t} \left.\right) - \frac{1}{\sqrt{\alpha_{t}}} \left(\right. \mathbf{x}_{t} - \frac{1 - \alpha_{t}}{\sqrt{1 - \bar{\alpha}_{t}}} \mathbf{\mathit{\epsilon}}_{\theta} \left(\right. \mathbf{x}_{t} , t \left.\right) \left.\right) \parallel^{2} \left]\right. \\ = \mathbb{E}_{\mathbf{x}_{0} , \mathbf{\mathit{\epsilon}}} \left[\right. \frac{\left(\right. 1 - \alpha_{t} \left.\right)^{2}}{2 \alpha_{t} \left(\right. 1 - \bar{\alpha}_{t} \left.\right) \parallel \mathbf{\Sigma}_{\theta} \parallel_{2}^{2}} \parallel \mathbf{\mathit{\epsilon}}_{t} - \mathbf{\mathit{\epsilon}}_{\theta} \left(\right. \mathbf{x}_{t} , t \left.\right) \parallel^{2} \left]\right. \\ = \mathbb{E}_{\mathbf{x}_{0} , \mathbf{\mathit{\epsilon}}} \left[\right. \frac{\left(\right. 1 - \alpha_{t} \left.\right)^{2}}{2 \alpha_{t} \left(\right. 1 - \bar{\alpha}_{t} \left.\right) \parallel \mathbf{\Sigma}_{\theta} \parallel_{2}^{2}} \parallel \mathbf{\mathit{\epsilon}}_{t} - \mathbf{\mathit{\epsilon}}_{\theta} \left(\right. \sqrt{\bar{\alpha}_{t}} \mathbf{x}_{0} + \sqrt{1 - \bar{\alpha}_{t}} \mathbf{\mathit{\epsilon}}_{t} , t \left.\right) \parallel^{2} \left]\right.
$$
...
$$
L_{t}^{\text{simple}} & = \mathbb{E}_{t sim \left[\right. 1 , T \left]\right. , \mathbf{x}_{0} , \mathbf{\mathit{\epsilon}}_{t}} \left[\right. \parallel \mathbf{\mathit{\epsilon}}_{t} - \mathbf{\mathit{\epsilon}}_{\theta} \left(\right. \mathbf{x}_{t} , t \left.\right) \parallel^{2} \left]\right. \\ = \mathbb{E}_{t sim \left[\right. 1 , T \left]\right. , \mathbf{x}_{0} , \mathbf{\mathit{\epsilon}}_{t}} \left[\right. \parallel \mathbf{\mathit{\epsilon}}_{t} - \mathbf{\mathit{\epsilon}}_{\theta} \left(\right. \sqrt{\bar{\alpha}_{t}} \mathbf{x}_{0} + \sqrt{1 - \bar{\alpha}_{t}} \mathbf{\mathit{\epsilon}}_{t} , t \left.\right) \parallel^{2} \left]\right.
$$
...
$$
\mathbf{s}_{\theta} \left(\right. \mathbf{x}_{t} , t \left.\right) \approx \nabla_{\mathbf{x}_{t}} log ⁡ q \left(\right. \mathbf{x}_{t} \left.\right) = \mathbb{E}_{q \left(\right. \mathbf{x}_{0} \left.\right)} \left[\right. \nabla_{\mathbf{x}_{t}} log ⁡ q \left(\right. \mathbf{x}_{t} \left|\right. \mathbf{x}_{0} \left.\right) \left]\right. = \mathbb{E}_{q \left(\right. \mathbf{x}_{0} \left.\right)} \left[\right. - \frac{\mathbf{\mathit{\epsilon}}_{\theta} \left(\right. \mathbf{x}_{t} , t \left.\right)}{\sqrt{1 - \bar{\alpha}_{t}}} \left]\right. = - \frac{\mathbf{\mathit{\epsilon}}_{\theta} \left(\right. \mathbf{x}_{t} , t \left.\right)}{\sqrt{1 - \bar{\alpha}_{t}}}
$$
...
$$
\beta_{t} = \text{clip} \left(\right. 1 - \frac{\bar{\alpha}_{t}}{\bar{\alpha}_{t - 1}} , 0.999 \left.\right) \bar{\alpha}_{t} = \frac{f \left(\right. t \left.\right)}{f \left(\right. 0 \left.\right)} \text{where } f \left(\right. t \left.\right) = cos ⁡ \left(\right. \frac{t / T + s}{1 + s} \cdot \frac{\pi}{2} \left.\right)^{2}
$$
...
$$
\mathbf{\Sigma}_{\theta} \left(\right. \mathbf{x}_{t} , t \left.\right) = exp ⁡ \left(\right. \mathbf{v} log ⁡ \beta_{t} + \left(\right. 1 - \mathbf{v} \left.\right) log ⁡ \overset{\sim}{\beta}_{t} \left.\right)
$$
...
$$
\nabla_{\mathbf{x}_{t}} log ⁡ q \left(\right. \mathbf{x}_{t} , y \left.\right) & = \nabla_{\mathbf{x}_{t}} log ⁡ q \left(\right. \mathbf{x}_{t} \left.\right) + \nabla_{\mathbf{x}_{t}} log ⁡ q \left(\right. y \left|\right. \mathbf{x}_{t} \left.\right) \\ \approx - \frac{1}{\sqrt{1 - \bar{\alpha}_{t}}} \mathbf{\mathit{\epsilon}}_{\theta} \left(\right. \mathbf{x}_{t} , t \left.\right) + \nabla_{\mathbf{x}_{t}} log ⁡ f_{\phi} \left(\right. y \left|\right. \mathbf{x}_{t} \left.\right) \\ = - \frac{1}{\sqrt{1 - \bar{\alpha}_{t}}} \left(\right. \mathbf{\mathit{\epsilon}}_{\theta} \left(\right. \mathbf{x}_{t} , t \left.\right) - \sqrt{1 - \bar{\alpha}_{t}} \nabla_{\mathbf{x}_{t}} log ⁡ f_{\phi} \left(\right. y \left|\right. \mathbf{x}_{t} \left.\right) \left.\right)
$$

Thus, a new classifier-guided predictor $\bar{\mathbf{\mathit{\epsilon}}}_{\theta}$ would take the form as following,

$$
\bar{\mathbf{\mathit{\epsilon}}}_{\theta} \left(\right. \mathbf{x}_{t} , t \left.\right) = \mathbf{\mathit{\epsilon}}_{\theta} \left(\right. x_{t} , t \left.\right) - \sqrt{1 - \bar{\alpha}_{t}} \nabla_{\mathbf{x}_{t}} log ⁡ f_{\phi} \left(\right. y \left|\right. \mathbf{x}_{t} \left.\right)
$$

To control the strength of the classifier guidance, we can add a weight $w$ to the delta part,

$$
\bar{\mathbf{\mathit{\epsilon}}}_{\theta} \left(\right. \mathbf{x}_{t} , t \left.\right) = \mathbf{\mathit{\epsilon}}_{\theta} \left(\right. x_{t} , t \left.\right) - \sqrt{1 - \bar{\alpha}_{t}} w \nabla_{\mathbf{x}_{t}} log ⁡ f_{\phi} \left(\right. y \left|\right. \mathbf{x}_{t} \left.\right)
$$
...
$$
\nabla_{\mathbf{x}_{t}} log ⁡ p \left(\right. y \left|\right. \mathbf{x}_{t} \left.\right) & = \nabla_{\mathbf{x}_{t}} log ⁡ p \left(\right. \mathbf{x}_{t} \left|\right. y \left.\right) - \nabla_{\mathbf{x}_{t}} log ⁡ p \left(\right. \mathbf{x}_{t} \left.\right) \\ = - \frac{1}{\sqrt{1 - \bar{\alpha}_{t}}} \left(\right. \mathbf{\mathit{\epsilon}}_{\theta} \left(\right. \mathbf{x}_{t} , t , y \left.\right) - \mathbf{\mathit{\epsilon}}_{\theta} \left(\right. \mathbf{x}_{t} , t \left.\right) \left.\right) \\ \bar{\mathbf{\mathit{\epsilon}}}_{\theta} \left(\right. \mathbf{x}_{t} , t , y \left.\right) & = \mathbf{\mathit{\epsilon}}_{\theta} \left(\right. \mathbf{x}_{t} , t , y \left.\right) - \sqrt{1 - \bar{\alpha}_{t}} w \nabla_{\mathbf{x}_{t}} log ⁡ p \left(\right. y \left|\right. \mathbf{x}_{t} \left.\right) \\ = \mathbf{\mathit{\epsilon}}_{\theta} \left(\right. \mathbf{x}_{t} , t , y \left.\right) + w \left(\right. \mathbf{\mathit{\epsilon}}_{\theta} \left(\right. \mathbf{x}_{t} , t , y \left.\right) - \mathbf{\mathit{\epsilon}}_{\theta} \left(\right. \mathbf{x}_{t} , t \left.\right) \left.\right) \\ = \left(\right. w + 1 \left.\right) \mathbf{\mathit{\epsilon}}_{\theta} \left(\right. \mathbf{x}_{t} , t , y \left.\right) - w \mathbf{\mathit{\epsilon}}_{\theta} \left(\right. \mathbf{x}_{t} , t \left.\right)
$$
...
$$
\mathbf{x}_{t - 1} & = \sqrt{\bar{\alpha}_{t - 1}} \mathbf{x}_{0} + \sqrt{1 - \bar{\alpha}_{t - 1}} \mathbf{\mathit{\epsilon}}_{t - 1} \\ = \sqrt{\bar{\alpha}_{t - 1}} \mathbf{x}_{0} + \sqrt{1 - \bar{\alpha}_{t - 1} - \sigma_{t}^{2}} \mathbf{\mathit{\epsilon}}_{t} + \sigma_{t} \mathbf{\mathit{\epsilon}} \\ = \sqrt{\bar{\alpha}_{t - 1}} \left(\right. \frac{\mathbf{x}_{t} - \sqrt{1 - \bar{\alpha}_{t}} \epsilon_{\theta}^{\left(\right. t \left.\right)} \left(\right. \mathbf{x}_{t} \left.\right)}{\sqrt{\bar{\alpha}_{t}}} \left.\right) + \sqrt{1 - \bar{\alpha}_{t - 1} - \sigma_{t}^{2}} \epsilon_{\theta}^{\left(\right. t \left.\right)} \left(\right. \mathbf{x}_{t} \left.\right) + \sigma_{t} \mathbf{\mathit{\epsilon}} \\ q_{\sigma} \left(\right. \mathbf{x}_{t - 1} \left|\right. \mathbf{x}_{t} , \mathbf{x}_{0} \left.\right) & = \mathcal{N} \left(\right. \mathbf{x}_{t - 1} ; \sqrt{\bar{\alpha}_{t - 1}} \left(\right. \frac{\mathbf{x}_{t} - \sqrt{1 - \bar{\alpha}_{t}} \epsilon_{\theta}^{\left(\right. t \left.\right)} \left(\right. \mathbf{x}_{t} \left.\right)}{\sqrt{\bar{\alpha}_{t}}} \left.\right) + \sqrt{1 - \bar{\alpha}_{t - 1} - \sigma_{t}^{2}} \epsilon_{\theta}^{\left(\right. t \left.\right)} \left(\right. \mathbf{x}_{t} \left.\right) , \sigma_{t}^{2} \mathbf{I} \left.\right)
$$
...
$$
q_{\sigma , s < t} \left(\right. \mathbf{x}_{s} \left|\right. \mathbf{x}_{t} , \mathbf{x}_{0} \left.\right) = \mathcal{N} \left(\right. \mathbf{x}_{s} ; \sqrt{\bar{\alpha}_{s}} \left(\right. \frac{\mathbf{x}_{t} - \sqrt{1 - \bar{\alpha}_{t}} \epsilon_{\theta}^{\left(\right. t \left.\right)} \left(\right. \mathbf{x}_{t} \left.\right)}{\sqrt{\bar{\alpha}_{t}}} \left.\right) + \sqrt{1 - \bar{\alpha}_{s} - \sigma_{t}^{2}} \epsilon_{\theta}^{\left(\right. t \left.\right)} \left(\right. \mathbf{x}_{t} \left.\right) , \sigma_{t}^{2} \mathbf{I} \left.\right)
$$
...
$$
f_{\theta} \left(\right. \mathbf{x} , t \left.\right) = c_{\text{skip}} \left(\right. t \left.\right) \mathbf{x} + c_{\text{out}} \left(\right. t \left.\right) F_{\theta} \left(\right. \mathbf{x} , t \left.\right)
$$
...
1. **Consistency Distillation (CD)**: Distill a diffusion model into a consistency model by minimizing the difference between model outputs for pairs generated out of the same trajectory. This enables a much cheaper sampling evaluation. The consistency distillation loss is:
	$$
	\mathcal{L}_{\text{CD}}^{N} \left(\right. \theta , \theta^{-} ; \phi \left.\right) & = \mathbb{E} \left[\right. \lambda \left(\right. t_{n} \left.\right) d \left(\right. f_{\theta} \left(\right. \mathbf{x}_{t_{n + 1}} , t_{n + 1} \left.\right) , f_{\theta^{-}} \left(\right. \hat{\mathbf{x}}_{t_{n}}^{\phi} , t_{n} \left.\right) \left]\right. \\ \hat{\mathbf{x}}_{t_{n}}^{\phi} & = \mathbf{x}_{t_{n + 1}} - \left(\right. t_{n} - t_{n + 1} \left.\right) \Phi \left(\right. \mathbf{x}_{t_{n + 1}} , t_{n + 1} ; \phi \left.\right)
	$$
	where
...
$$
\mathcal{L}_{\text{CT}}^{N} \left(\right. \theta , \theta^{-} ; \phi \left.\right) = \mathbb{E} \left[\right. \lambda \left(\right. t_{n} \left.\right) d \left(\right. f_{\theta} \left(\right. \mathbf{x} + t_{n + 1} \mathbf{z} , t_{n + 1} \left.\right) , f_{\theta^{-}} \left(\right. \mathbf{x} + t_{n} \mathbf{z} , t_{n} \left.\right) \left]\right. \text{where } \mathbf{z} \in \mathcal{N} \left(\right. 0 , \mathbf{I} \left.\right)
$$
...
$$
\text{Attention} \left(\right. \mathbf{Q} , \mathbf{K} , \mathbf{V} \left.\right) = \text{softmax} \left(\right. \frac{\mathbf{Q} \mathbf{K}^{\top}}{\sqrt{d}} \left.\right) \cdot \mathbf{V} \\ \text{where } \mathbf{Q} = \mathbf{W}_{Q}^{\left(\right. i \left.\right)} \cdot \varphi_{i} \left(\right. \mathbf{z}_{i} \left.\right) , \mathbf{K} = \mathbf{W}_{K}^{\left(\right. i \left.\right)} \cdot \tau_{\theta} \left(\right. y \left.\right) , \mathbf{V} = \mathbf{W}_{V}^{\left(\right. i \left.\right)} \cdot \tau_{\theta} \left(\right. y \left.\right) \\ \text{and } \mathbf{W}_{Q}^{\left(\right. i \left.\right)} \in \mathbb{R}^{d \times d_{\epsilon}^{i}} , \mathbf{W}_{K}^{\left(\right. i \left.\right)} , \mathbf{W}_{V}^{\left(\right. i \left.\right)} \in \mathbb{R}^{d \times d_{\tau}} , \varphi_{i} \left(\right. \mathbf{z}_{i} \left.\right) \in \mathbb{R}^{N \times d_{\epsilon}^{i}} , \tau_{\theta} \left(\right. y \left.\right) \in \mathbb{R}^{M \times d_{\tau}}
$$
...
$$
\underset{\mathbf{c}^{i} \text{is deterministic given } \mathbf{x}}{\underbrace{P \left(\right. \mathbf{x} \left|\right. y \left.\right) = P \left(\right. \mathbf{x} , \mathbf{c}^{i} \left|\right. y \left.\right)}} = P \left(\right. \mathbf{x} \left|\right. \mathbf{c}^{i} , y \left.\right) P \left(\right. \mathbf{c}^{i} \left|\right. y \left.\right)
$$
